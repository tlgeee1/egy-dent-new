    ...
    <>
      <motion.header
        ...
        className={cn(
          ...
          scrolled ? "glass border-b border-white/[0.06] py-3 shadow-[0_10px_40px_rgba(0,0,0,0.45)]" : "py-5",
        )}
      >
        <nav className="mx-auto flex max-w-7xl items-center justify-between px-5 lg:px-8">
          ...
          <ul className="hidden items-center gap-1 lg:flex">
            {links.map((l) => (
              <li key={l.href}>
                <a
                  href={l.href}
                  className="rounded-full px-4 py-2 text-sm font-medium text-frost-300 transition-colors hover:bg-white/5 hover:text-white"
                >
                  {l.label}
                </a>
              </li>
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              className="hidden items-center gap-2 rounded-full border border-white/10 px-4 py-2 text-sm font-semibold text-frost-300 transition-colors hover:border-volt-500/40 hover:text-volt-300 xl:flex"
              dir="ltr"
            >
            ...
            <button
              ...
              className="relative grid size-11 place-items-center rounded-2xl bg-gradient-to-br from-volt-500 to-volt-700 text-ink-950 shadow-[0_8px_24px_rgba(34,211,238,0.35)] transition-transform hover:scale-105 active:scale-95"
              ...
              <AnimatePresence>
                {count > 0 && (
                  <motion.span
                    ...
                    className="absolute -left-1.5 -top-1.5 grid min-w-6 place-items-center rounded-full border-2 border-ink-950 bg-gold-400 px-1 font-display text-xs font-black text-ink-950"
                  >
                    {count}
                  </motion.span>
                )}
            ...
            <button
              ...
              className="grid size-11 place-items-center rounded-2xl border border-white/10 text-frost-300 lg:hidden"
              aria-label="القائمة"
            >
        ...
        {menu && (
          ...
          >
            ...
            <motion.div
              ...
              className="absolute inset-y-0 right-0 flex w-80 max-w-[85vw] flex-col border-l border-white/[0.07] bg-ink-900 p-6"
            >
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className="grid size-10 place-items-center rounded-xl border border-white/10 text-frost-300"
                  aria-label="إغلاق"
                >
                  <X className="size-5" />
                </button>
