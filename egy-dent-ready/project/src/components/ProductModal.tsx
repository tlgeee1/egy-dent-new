      ...
      {p && (
        <div className="fixed inset-0 z-[170] grid place-items-center p-4">
          ...
          <motion.div
            ...
            className="relative max-h-[92vh] w-full max-w-4xl overflow-y-auto rounded-[2rem] border border-white/10 bg-ink-900 shadow-2xl"
          >
            <button
              onClick={() => setQuickView(null)}
              className="absolute left-4 top-4 z-10 grid size-10 place-items-center rounded-xl border border-white/10 bg-ink-950/60 text-frost-300 backdrop-blur-md transition-colors hover:bg-white/10"
              aria-label="إغلاق"
            >
              <X className="size-5" />
            </button>
            ...
            <div className="grid md:grid-cols-2">
              ...
              <div className="relative min-h-72">
                ...
                {p.badge && (
                  <span className="absolute right-5 top-5 rounded-full bg-gradient-to-l from-gold-400 to-gold-500 px-3.5 py-1.5 font-display text-xs font-black text-ink-950">
                    {p.badge}
                  </span>
                )}
              </div>
              ...
              <div className="flex flex-col p-6 md:p-9">
                ...
                <div className="mt-6 flex items-end gap-3 border-t border-white/[0.07] pt-6">
                  <div>
                ...
                <div className="mt-6 flex items-center gap-3">
                  <div className="flex items-center gap-1 rounded-2xl border border-white/10 p-1.5">
                    <button
                      onClick={() => setQty(Math.max(1, qty - 1))}
                      className="grid size-9 place-items-center rounded-xl text-frost-300 transition-colors hover:bg-white/10"
                      aria-label="تقليل"
                    >
                  ...
                  <button
                    ...
                    className="flex flex-1 items-center justify-center gap-2 rounded-2xl bg-gradient-to-l from-volt-400 to-volt-600 py-3.5 font-display font-black text-ink-950 shadow-[0_12px_30px_rgba(34,211,238,0.3)] transition-transform hover:scale-[1.02] active:scale-95"
                  >
