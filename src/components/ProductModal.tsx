                  ...
                  <>
                    ...
                    <div className="mt-6 flex items-center gap-3">
                      ...
                      <button
                        ...
                        className="flex flex-1 items-center justify-center gap-2 rounded-2xl bg-gradient-to-l from-volt-400 to-volt-600 py-3.5 font-display font-black text-[var(--onvolt)] shadow-[0_12px_30px_rgba(34,211,238,0.3)] transition-transform hover:scale-[1.02] active:scale-95"
                      >
