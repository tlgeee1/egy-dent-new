      ...
      {isOpen && (
        <div className="fixed inset-0 z-[160]">
          ...
          <motion.aside
            ...
            className="absolute inset-y-0 left-0 flex w-full max-w-md flex-col border-r border-[var(--line-6)] bg-ink-900 shadow-2xl"
          >
            {/* header */}
            <div className="flex items-center justify-between border-b border-[var(--line-2)] p-5">
              ...
              <button
                onClick={() => setOpen(false)}
                className="grid size-10 place-items-center rounded-xl border border-[var(--line-3)] text-frost-300 transition-colors hover:bg-[var(--fill-4)]"
            ...
            {lines.length === 0 ? (
              <div className="grid flex-1 place-items-center p-8 text-center">
                <div>
                  <span className="mx-auto grid size-24 place-items-center rounded-full border border-dashed border-[var(--line-4)] text-frost-500">
                  ...
                  <button
                    onClick={() => setOpen(false)}
                    className="mt-7 inline-flex items-center gap-2 rounded-2xl bg-gradient-to-l from-volt-400 to-volt-600 px-7 py-3.5 font-display font-extrabold text-[var(--onaccent)] transition-transform hover:scale-105"
                  >
                    ابدأ التسوق
              ...
              <>
                    ...
                    {lines.map((l) => {
                      ...
                      return (
                        <motion.div
                          ...
                          className="flex gap-3.5 rounded-2xl border border-[var(--line-2)] bg-ink-800/60 p-3"
                        >
                          ...
                          <div className="flex min-w-0 flex-1 flex-col">
                            ...
                            <div className="mt-auto flex items-center justify-between pt-2">
                              <div className="flex items-center gap-1 rounded-xl border border-[var(--line-3)] p-1">
                                <button
                                  onClick={() => setQty(l.id, l.qty - 1)}
                                  className="grid size-7 place-items-center rounded-lg text-frost-300 transition-colors hover:bg-[var(--fill-6)]"
                ...
                {/* footer */}
                <div className="border-t border-[var(--line-2)] p-5">
                  ...
                  <button
                    ...
                    className="mt-4 flex w-full items-center justify-center gap-2.5 rounded-2xl bg-gradient-to-l from-volt-400 to-volt-600 py-4 font-display text-lg font-black text-[var(--onaccent)] shadow-[0_14px_36px_rgba(34,211,238,0.35)] transition-transform hover:scale-[1.02] active:scale-95"
                  >
