      ...
      <div className="mx-auto max-w-7xl px-5 lg:px-8">
        <Reveal>
          <div className="relative overflow-hidden rounded-[2.5rem] border border-volt-500/20">
            ...
            <span
              className="pointer-events-none absolute -bottom-16 left-4 select-none font-display text-[11rem] font-black leading-none text-[var(--text-faint)] md:text-[17rem]"
              dir="ltr"
            >
              20%
            </span>
            ...
            <div className="relative grid items-center gap-10 p-8 md:p-14 lg:grid-cols-[1.1fr_0.9fr]">
              <div className="text-center lg:text-right">
                ...
                <p className="mx-auto mt-4 max-w-md leading-loose text-[var(--text-primary-70)] lg:mx-0">
                  استخدم الكود <span className="rounded-lg bg-[var(--fill-6)] px-2.5 py-1 font-display font-black tracking-widest text-gold-300" dir="ltr">EGY20</span> عند
                  الطلب — على الأجهزة والمستهلكات وكل حاجة.
                </p>
                <a
                  href="#products"
                  className="mt-8 inline-flex items-center gap-2.5 rounded-2xl bg-white px-9 py-4 font-display text-lg font-black text-[var(--onaccent)] shadow-[0_16px_44px_rgba(255,255,255,0.25)] transition-transform hover:scale-[1.04] active:scale-95"
                >
              ...
              <div className="grid grid-cols-4 gap-3 md:gap-4" dir="ltr">
                {units.map((u) => (
                  <div
                    key={u.l}
                    className="rounded-3xl border border-[var(--line-4)] bg-[var(--fill-5)] px-2 py-6 text-center backdrop-blur-md md:py-8"
                  >
                    <p className="font-display text-4xl font-black tabular-nums text-[var(--text-primary)] md:text-5xl">
