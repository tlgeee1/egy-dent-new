      ...
      <div className="mx-auto max-w-7xl px-5 lg:px-8">
        <Reveal>
          <div className="relative overflow-hidden rounded-[2.5rem] border border-volt-500/20">
            {/* bg */}
            <div className="absolute inset-0 bg-gradient-to-bl from-[#0e7490] via-[#0b3b52] to-[#070b18]" />
            <div className="absolute inset-0 bg-grid opacity-40" />
            <div className="absolute -top-24 left-1/4 size-96 rounded-full bg-volt-400/20 blur-[110px]" />
            <span
              className="pointer-events-none absolute -bottom-16 left-4 select-none font-display text-[11rem] font-black leading-none text-white/5 md:text-[17rem]"
              dir="ltr"
            >
              20%
            </span>
            ...
            <div className="relative grid items-center gap-10 p-8 md:p-14 lg:grid-cols-[1.1fr_0.9fr]">
              <div className="text-center lg:text-right">
                ...
                <h2 className="mt-6 font-display text-4xl font-black leading-tight text-white md:text-6xl">
                ...
                <a
                  href="#products"
                  className="mt-8 inline-flex items-center gap-2.5 rounded-2xl bg-white px-9 py-4 font-display text-lg font-black text-[#04060d] shadow-[0_16px_44px_rgba(255,255,255,0.25)] transition-transform hover:scale-[1.04] active:scale-95"
                >
