  ...
  return (
    <section id="branches" className="relative py-24 md:py-32">
      <div className="mx-auto max-w-7xl px-5 lg:px-8">
        ...
        <div className="mt-14 grid gap-5 md:grid-cols-3">
          {branches.map((b, i) => (
            <Reveal key={b.city} delay={i * 0.1}>
              <div className="group relative h-full overflow-hidden rounded-[1.75rem] border border-white/[0.07] bg-ink-900 p-7 transition-all duration-500 hover:-translate-y-2 hover:border-volt-500/40 hover:shadow-[0_28px_70px_rgba(0,0,0,0.5)]">
                ...
                <div className="relative">
                  <div className="flex items-start justify-between">
                    <span className="grid size-14 place-items-center rounded-2xl bg-gradient-to-br from-volt-400 to-volt-700 text-ink-950 shadow-[0_10px_26px_rgba(34,211,238,0.3)]">
                      <MapPin className="size-6" />
                    </span>
                    <span className="font-display text-4xl font-black text-white/[0.06]" dir="ltr">
                  ...
                  <div className="mt-6 space-y-2.5 border-t border-white/[0.07] pt-5 text-sm">
        ...
        {/* payments */}
        <Reveal delay={0.15}>
          <div className="mt-14 rounded-[2rem] border border-white/[0.07] bg-ink-900 p-8 md:p-10">
            <div className="flex flex-wrap items-center justify-center gap-x-10 gap-y-6">
              ...
              <div className="flex flex-wrap items-center justify-center gap-2.5">
                {payments.map((p) => (
                  <span
                    key={p}
                    className="rounded-full border border-white/10 bg-white/[0.03] px-4 py-2 text-xs font-bold text-frost-300 transition-colors hover:border-volt-500/40 hover:text-volt-300 md:text-sm"
                  >
                    {p}
                  </span>
                ))}
