        ...
        <div className="grid items-center gap-14 pb-16 lg:grid-cols-[1.05fr_0.95fr] lg:gap-8 lg:pb-24">
          ...
          <motion.div variants={stagger} initial="hidden" animate="show" className="relative z-10 text-center lg:text-right">
            ...
            <motion.div variants={item} className="mt-9 flex flex-col items-center gap-4 sm:flex-row sm:justify-center lg:justify-start">
              <a
                href="#products"
                className="group relative w-full overflow-hidden rounded-2xl bg-gradient-to-l from-volt-400 to-volt-600 px-9 py-4 text-center font-display text-lg font-extrabold text-[var(--onaccent)] shadow-[0_16px_40px_rgba(34,211,238,0.35)] transition-transform hover:scale-[1.03] active:scale-95 sm:w-auto"
              >
                <span className="relative z-10">تسوّق المنتجات</span>
                <span className="absolute inset-y-0 w-1/3 bg-[var(--fill-7)] blur-md animate-shine" />
              </a>
              <a
                href="#offer"
            ...
            <motion.dl variants={item} className="mt-12 flex items-center justify-center gap-8 sm:gap-12 lg:justify-start">
              {[
                ...
                <div key={l} className={i > 0 ? "border-r border-[var(--line-3)] pr-8 sm:pr-12" : ""}>
                  ...
                  <dd className="font-display text-2xl font-black text-[var(--text-primary)] md:text-3xl" dir="ltr">
                    {v}
                  </dd>
          ...
          >
            <motion.div style={{ rotateX: rx, rotateY: ry }} className="relative will-change-transform">
              ...
              >
                <div className="glass animate-float rounded-2xl border border-[var(--line-4)] px-4 py-3 shadow-[0_16px_40px_rgba(0,0,0,0.5)]">
                  <div className="flex items-center gap-2.5">
